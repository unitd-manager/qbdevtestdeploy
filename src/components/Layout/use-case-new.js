...
export default function UseCaseGrid({ data }) {
    ...
    // ✅ NEW STATE for selected industries
        ...
        <SectionTag className={`use-cases-grid-section ${class_name}`} id={`${id}`}>
            <DivTag className="container">
                <DivTag className={`sub-section ${paddingClass}`}>
                                ...
                                return (
                                    ...
                                    >
                                        <DivTag className="icon-box">
                                            ...
                                            {/* ✅ CHECKBOX UI */}
                                            <DivTag className="industry-checkbox">
                    ...
                    {/* ✅ Selected industries output (optional) */}
                    {selectedIndustries.length > 0 && (
                        <DivTag className="selected-industries">
                            <strong>Selected:</strong> {selectedIndustries.join(', ')}
                        </DivTag>
                    )}
