...
export default function AboutHighlights({ data }) {
    ...
    return (
        <SectionTag className={`acf-section about-strategic-highlight-block  ${isRight ? 'about-strategic-highlight-block-right' : 'about-strategic-highlight-block-left'} ${class_name}`} id={id}>
