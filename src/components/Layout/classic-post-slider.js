...
import { DivTag, H2Tag, H4Tag, SectionTag, SpanTag } from "../Common/HTMLTags";
import Image from "next/image";

export default function ClassicPostBlogSlider({ data }) {
    ...
    const setEqualHeight = useCallback(() => {
        ...
        const visibleSlides = sliderRef.current.querySelectorAll(
            '.slick-slide.slick-active:not(.slick-cloned) .slider-item'
        );
                                    ...
                                    <DivTag key={index}>
                                        <DivTag className="slider-item">
                                            ...
                                            <DivTag className="post-content">
                                                ...
                                                {(show_description === 'yes' && post.excerpt) && (
                                                    <DivTag
                                                        className="post-desc"
