...
export default async function CareerInnerPage({ params }) {
    const resolvedParams = await params;
    ...
    try {
        ...
        if (!pageData || !pageData.acf || !pageData.acf.layouts?.length) {
            return (
                <DivTag className="career-inner-page">
        ...
        return (
            <DivTag className="career-inner-page light-gray">
                <StructuredData data={structuredData} />
