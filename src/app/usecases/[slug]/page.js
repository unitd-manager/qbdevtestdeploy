...
export default async function UsecaseSinglePage({ params }) {
    ...
    try {
        ...
        if (!pageData || !pageData.acf || !pageData.acf.layouts?.length) {
            return (
                <DivTag className="use-case-single-page">
        ...
        return (
            <DivTag className="use-case-single-page light-gray">
                <StructuredData data={structuredData} />
