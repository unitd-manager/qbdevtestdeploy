...
const parent_path = 'resources/white-papers';
...
export default async function WhitePapersInnerPage({ params }) {
    const resolvedParams = await params;
    ...
    try {
        ...
        if (!pageData || !pageData.acf || !pageData.acf.layouts?.length) {
            return (
                <DivTag className="white-papers-inner-page">
        ...
        return (
            <DivTag className="white-papers-inner-page light-gray">
                <StructuredData data={structuredData} />
