...
export default async function ParnersSinglePage({ params }) {
    ...
    try {
        ...
        if (!pageData || !pageData.acf || !pageData.acf.layouts?.length) {
            return (
                <DivTag className="parners-single-page">
        ...
        return (
            <DivTag className="parners-single-page light-gray">
                <StructuredData data={structuredData} />
        ...
        return (
            <DivTag className="newsroom-single-page light-gray">
